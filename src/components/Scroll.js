...
import heart from "../Assets/ginger1.png";
    ...
    <div>
      <Fixedbar />
        <Box className={classes.scrolldetails}>
          ...
          <Typography className={classes.lorem}>
            Our Tea Tree Night Lotion helps you snooze your way to dreamy
            looking skin. Blemishes? Time for this little guy to get to work.
          </Typography>
          <Typography className={classes.lorem}>
            While you sleep your skin is in recovery mode and so it’s the
            perfect time to slather on some hard-working skincare. This
            lightweight night lotion helps your skin feel moisturised while
            absorbing excess oil and sebum, so you can wake up to refreshed skin
            that looks and more balanced. Sounds like a dream, right?
          </Typography>
          <Typography className={classes.lorem}>
          ...
          <Typography className={classes.lorem}>
            And if you’re on the hunt for more than just a night lotion, The
            Body Shop’s Tea Tree range is full of more blemish-battling goodies.
          </Typography>
          <Box component="div" className={classes.verticalLine} />
          <Typography className={classes.offers}>How to Use</Typography>
          <Box className={classes.video}>
            <Box className={classes.uses}>
              <img src={heart} alt="" className={classes.uses} />
            </Box>
            <Box>
          ...
          <Typography className={classes.lorem}>
            This stuff is like liquid gold, rich in vitamin E and
            polyunsaturated fatty acids that are super nourishing for skin
          </Typography>
          <Typography className={classes.offers2}>Argan Oil</Typography>
          <Typography className={classes.lorem}>
            This stuff is like liquid gold, rich in vitamin E and
          ...
          <Typography className={classes.lorem}>
            Apply to lips straight from the bullet or with a Lipstick &
            Concealer Brush. Four steps to the perfect pout:
          </Typography>
          <Typography className={classes.lorem}>
          ...
          <Typography className={classes.lorem}>
            Our Community Fair Trade tea tree oil is sustainably sourced in
            Kenya. We partner with a number of independent farmers who
            steam-distil the leaves within 12 hours of harvest, to make sure
            we’re bottling our purest and most potent oil. The oil from around
            15,000 tea tree leaves goes into every 20ml bottle of Tea Tree Oil.
          </Typography>
          <Typography className={classes.lorem}>
